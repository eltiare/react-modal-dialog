...
var ModalDialog = (function (_React$Component) {
  ...
  function ModalDialog() {
    ...
    this.render = function () {
      ...
      var closeDiameter = _props.closeDiameter;

      var rest = _objectWithoutProperties(_props, ['children', 'className', 'componentIsLeaving', 'left', 'leftOffset', 'margin', 'onClose', 'recenter', 'sheet', 'style', 'top', 'topOffset', 'width', 'closeClassName', 'closeDiameter']);
      ...
      var closeHandlerClassName = (0, _classnames2['default'])(classes.closeButton, closeClassName);
      ...
      return _react2['default'].createElement(
        ...
        onClose ? _react2['default'].createElement(
          'a',
          { className: closeHandlerClassName, onClick: onClose },
          _react2['default'].createElement(_CloseCircle2['default'], { diameter: closeDiameter || 40 })
        ) : null,
        children
      );
    };
